...
final class ReflBasedFunM8[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, +R](delegate: java.lang.reflect.Method, args: Array[Object]) extends AbstractFunction8[T1, T2, T3, T4, T5, T6, T7, T8, R] {
