...
final class ReflBasedFunR6[-T1, -T2, -T3, -T4, -T5, -T6, +R](delegate: java.lang.reflect.Method, receiver: Object, args: Array[Object]) extends AbstractFunction6[T1, T2, T3, T4, T5, T6, R] {
