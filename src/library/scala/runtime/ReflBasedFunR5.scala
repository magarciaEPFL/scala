...
final class ReflBasedFunR5[-T1, -T2, -T3, -T4, -T5, +R](delegate: java.lang.reflect.Method, receiver: Object, args: Array[Object]) extends AbstractFunction5[T1, T2, T3, T4, T5, R] {
