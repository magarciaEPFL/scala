...
final class ReflBasedFunR9[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, -T9, +R](delegate: java.lang.reflect.Method, receiver: Object, args: Array[Object]) extends AbstractFunction9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R] {
