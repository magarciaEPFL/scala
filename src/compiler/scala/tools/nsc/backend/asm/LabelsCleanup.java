...
package scala.tools.nsc.backend.asm;
...
public class LabelsCleanup {
    ...
    /**
     *  All LabelNodes referred from anywhere in the MethodNode are collected,
     *  and grouped according to category (target of control-flow transfer,
     *  delimiter of a the code region protected by an exception handler,
     *  debug info).
     *  
     */
